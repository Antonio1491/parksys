          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">Eventos programados</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">Activos en el sistema</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">En inventario</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">Visitantes totales</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">Amenidades disponibles</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">Instructores activos</p>
              </CardContent>
            </Card>
