...
import { Loader2, MapPin, Ruler, Plus, X, TreeDeciduous, ArrowRight, ArrowLeft, MapPinned, Stethoscope } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-2 border-2 border-[#00444f] rounded-full">
                <TreeDeciduous className="h-5 w-5 text-[#00444f]" />
              </div>
              <div>
                <h1 className="text-3xl font-poppins font-bold text-[#00444f]">Nuevo Árbol</h1>
              </div>
            </div>
                    ...
                    <CardHeader>
                      <div className="flex items-center gap-3">
                        <div className="p-2 border-2 border-gray-800 rounded-full">
                          <MapPinned className="h-4 w-4 text-gray-800" />
                        </div>
                        <h3 className="text-lg font-medium">Datos de Ubicación</h3>
                      </div>
                    </CardHeader>
                ...
                <TabsContent value="health">
                  <Card>
                    <CardHeader>
                      <div className="flex items-center gap-3">
                        <div className="p-2 border-2 border-gray-800 rounded-full">
                          <Stethoscope className="h-4 w-4 text-gray-800" />
                        </div>
                        <h3 className="text-lg font-medium">Estado y Observaciones</h3>
                      </div>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
