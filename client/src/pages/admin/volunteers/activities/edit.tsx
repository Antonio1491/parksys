...
import { CalendarIcon, Clock, Users, MapPin, FileText, AlertCircle, Loader2 } from "lucide-react";
...
export default function EditVolunteerActivity() {
  ...
  useEffect(() => {
    if (activity) {
      ...
      const timeString = format(activityDate, "HH:mm");
      ...
      form.reset({
        ...
        scheduledHours: activity.scheduledHours ? parseFloat(activity.scheduledHours) : undefined,
        maxVolunteers: activity.maxVolunteers || 10,
        supervisorId: activity.supervisorId || undefined,
  ...
  const updateActivity = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: [`/api/volunteer-activities/${activityId}`] });
      toast({
        title: "✅ Actividad actualizada",
        description: "La actividad se ha actualizado exitosamente.",
      });
      setLocation(ROUTES.admin.volunteers.activities.view.build(activityId));
    },
    onError: (error: any) => {
      toast({
        title: "❌ Error",
    ...
    return (
      ...
      <div className="container mx-auto p-6">
        <div className="text-center py-12">
          <Loader2 className="h-12 w-12 animate-spin mx-auto mb-4 text-[#00a587]" />
    ...
    <div className="mx-auto">
      ...
      <div className="mt-6 mb-8">
        <h1 className="text-3xl font-bold text-gray-900">
          Editar Actividad de Voluntariado
        </h1>
        <p className="text-gray-600 mt-2">
          Actualiza la información de la actividad "{activity.name}"
        </p>
      </div>
      ...
      <Alert className="mb-6 border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-800">
          Los cambios se aplicarán a la actividad y afectarán a todos los voluntarios inscritos.
        </AlertDescription>
      </Alert>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end gap-3 pt-4">
          <Button
            type="button"
            variant="outline"
            onClick={() => setLocation(ROUTES.admin.volunteers.activities.view.build(activityId))}
