...
const adminNavStructure: AdminNavItem[] = [
  ...
  },
  {
    ...
    icon: FolderOpen,
    children: [
      { labelKey: 'navigation.parks', href: ROUTES.dashboards.parks },
      { labelKey: 'navigation.activities', href: ROUTES.dashboards.activities },
      { labelKey: 'navigation.amenities', href: ROUTES.dashboards.amenities },
      { labelKey: 'navigation.trees', href: ROUTES.dashboards.trees },
      { labelKey: 'navigation.visitors', href: ROUTES.dashboards.visitors },
      { labelKey: 'navigation.events', href: ROUTES.dashboards.events },
      { labelKey: 'navigation.reservations', href: ROUTES.dashboards.reservations },
      { labelKey: 'navigation.evaluations', href: ROUTES.dashboards.evaluations },
    ],
  },
  {
    ...
    icon: Wrench,
    children: [
      { labelKey: 'navigation.assets', href: ROUTES.dashboards.assets },
      { labelKey: 'navigation.incidents', href: ROUTES.dashboards.incidents },
      { labelKey: 'navigation.workOrders', href: ROUTES.dashboards.workOrders },
      { labelKey: 'navigation.warehouse', href: ROUTES.dashboards.warehouse },
      { labelKey: 'navigation.volunteers', href: ROUTES.dashboards.volunteers },
    ],
  },
  {
    ...
    icon: DollarSign,
    children: [
      { labelKey: 'navigation.finance', href: ROUTES.dashboards.finance },
      { labelKey: 'navigation.accounting', href: ROUTES.dashboards.accounting },
      { labelKey: 'navigation.concessions', href: ROUTES.dashboards.concessions },
    ],
  },
  {
